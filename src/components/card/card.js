  ...
  render() {
    ...
    return(
      ...
      { 
        ...
        poster_path === '' ? <img alt='movie poster' src={poster_path} style={{zIndex: 1, position: 'relative', bottom: '50px', height: '300px', width: '400px' }} /> :
        <img alt='movie poster' src="https://via.placeholder.com/300x400" style={{zIndex: 1, position: 'relative', bottom: '50px', height: '300px', width: '400px' }} />
      }
